package com.asdzheng.sweetshow.ui.view.waveswiperefreshlayout;
...
public class WaveSwipeRefreshLayout extends ViewGroup {
    ...
    private static final String LOG_TAG = WaveSwipeRefreshLayout.class.getSimpleName();
    ...
    public static int DRAWUP = 1;
    public static int DRAWDOWN = 2;
    private int mode = FREE;
    ...
    private int mWaveMaxHeight = 100;
        ...
        if (loading) {
            ...
            valueAnimator.addListener(new Animator.AnimatorListener() {
                ...
                public void onAnimationEnd(Animator animation) {
                    mWaterWave.setVisibility(View.GONE);
                    mLoading = loading;
                }
...
//        drawChild(canvas,mTarget,getDrawingTime());
...
//        }
    ...
    public void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        mWaterWave.measure(MeasureSpec.makeMeasureSpec(widthMeasureSpec, MeasureSpec.AT_MOST),
                MeasureSpec.makeMeasureSpec(mWaveMaxHeight, MeasureSpec.EXACTLY));
