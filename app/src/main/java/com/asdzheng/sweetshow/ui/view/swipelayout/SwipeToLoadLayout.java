package com.asdzheng.sweetshow.ui.view.swipelayout;
...
public class SwipeToLoadLayout extends ViewGroup {
    ...
    private static final String TAG = com.aspsine.swipetoloadlayout.SwipeToLoadLayout.class.getSimpleName();
    ...
    public SwipeToLoadLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        final TypedArray a = context.obtainStyledAttributes(attrs, com.aspsine.swipetoloadlayout.R.styleable.SwipeToLoadLayout, defStyleAttr, 0);
        try {
            final int N = a.getIndexCount();
            for (int i = 0; i < N; i++) {
                int attr = a.getIndex(i);
                if (attr == com.aspsine.swipetoloadlayout.R.styleable.SwipeToLoadLayout_refresh_enabled) {
                    setRefreshEnabled(a.getBoolean(attr, true));

                } else if (attr == com.aspsine.swipetoloadlayout.R.styleable.SwipeToLoadLayout_load_more_enabled) {
                    setLoadMoreEnabled(a.getBoolean(attr, true));

                } else if (attr == com.aspsine.swipetoloadlayout.R.styleable.SwipeToLoadLayout_swipe_style) {
                    setSwipeStyle(a.getInt(attr, STYLE.CLASSIC));

                } else if (attr == com.aspsine.swipetoloadlayout.R.styleable.SwipeToLoadLayout_refresh_final_drag_offset) {
                    setRefreshFinalDragOffset(a.getDimensionPixelOffset(attr, 0));

                } else if (attr == com.aspsine.swipetoloadlayout.R.styleable.SwipeToLoadLayout_load_more_final_drag_offset) {
                    setLoadMoreFinalDragOffset(a.getDimensionPixelOffset(attr, 0));

                } else if (attr == com.aspsine.swipetoloadlayout.R.styleable.SwipeToLoadLayout_refresh_trigger_offset) {
                    setRefreshTriggerOffset(a.getDimensionPixelOffset(attr, 0));

                } else if (attr == com.aspsine.swipetoloadlayout.R.styleable.SwipeToLoadLayout_load_more_trigger_offset) {
                    setLoadMoreTriggerOffset(a.getDimensionPixelOffset(attr, 0));

                } else if (attr == com.aspsine.swipetoloadlayout.R.styleable.SwipeToLoadLayout_release_to_refreshing_scrolling_duration) {
                    setReleaseToRefreshingScrollingDuration(a.getInt(attr, DEFAULT_RELEASE_TO_REFRESHING_SCROLLING_DURATION));

                } else if (attr == com.aspsine.swipetoloadlayout.R.styleable.SwipeToLoadLayout_refresh_complete_delay_duration) {
                    setRefreshCompleteDelayDuration(a.getInt(attr, DEFAULT_REFRESH_COMPLETE_DELAY_DURATION));

                } else if (attr == com.aspsine.swipetoloadlayout.R.styleable.SwipeToLoadLayout_refresh_complete_to_default_scrolling_duration) {
                    setRefreshCompleteToDefaultScrollingDuration(a.getInt(attr, DEFAULT_REFRESH_COMPLETE_TO_DEFAULT_SCROLLING_DURATION));

                } else if (attr == com.aspsine.swipetoloadlayout.R.styleable.SwipeToLoadLayout_default_to_refreshing_scrolling_duration) {
                    setDefaultToRefreshingScrollingDuration(a.getInt(attr, DEFAULT_DEFAULT_TO_REFRESHING_SCROLLING_DURATION));

                } else if (attr == com.aspsine.swipetoloadlayout.R.styleable.SwipeToLoadLayout_release_to_loading_more_scrolling_duration) {
                    setReleaseToLoadingMoreScrollingDuration(a.getInt(attr, DEFAULT_RELEASE_TO_LOADING_MORE_SCROLLING_DURATION));

                } else if (attr == com.aspsine.swipetoloadlayout.R.styleable.SwipeToLoadLayout_load_more_complete_delay_duration) {
                    setLoadMoreCompleteDelayDuration(a.getInt(attr, DEFAULT_LOAD_MORE_COMPLETE_DELAY_DURATION));

                } else if (attr == com.aspsine.swipetoloadlayout.R.styleable.SwipeToLoadLayout_load_more_complete_to_default_scrolling_duration) {
                    setLoadMoreCompleteToDefaultScrollingDuration(a.getInt(attr, DEFAULT_LOAD_MORE_COMPLETE_TO_DEFAULT_SCROLLING_DURATION));

                } else if (attr == com.aspsine.swipetoloadlayout.R.styleable.SwipeToLoadLayout_default_to_loading_more_scrolling_duration) {
    ...
    /**
     * set an {@link com.aspsine.swipetoloadlayout.OnRefreshListener} to listening refresh event
     *
     * @param listener
     */
    ...
    protected ViewGroup.LayoutParams generateDefaultLayoutParams() {
        return new com.aspsine.swipetoloadlayout.SwipeToLoadLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.MATCH_PARENT);
    }
    ...
    protected ViewGroup.LayoutParams generateLayoutParams(ViewGroup.LayoutParams p) {
        return new com.aspsine.swipetoloadlayout.SwipeToLoadLayout.LayoutParams(p);
    }
    ...
    public ViewGroup.LayoutParams generateLayoutParams(AttributeSet attrs) {
        return new com.aspsine.swipetoloadlayout.SwipeToLoadLayout.LayoutParams(getContext(), attrs);
    }
    ...
    protected void onFinishInflate() {
        ...
        if (childNum == 0) {
            ...
            mHeaderView = findViewById(com.aspsine.swipetoloadlayout.R.id.swipe_refresh_header);
            mTargetView = findViewById(com.aspsine.swipetoloadlayout.R.id.swipe_target);
            mFooterView = findViewById(com.aspsine.swipetoloadlayout.R.id.swipe_load_more_footer);
        } else {
    ...
    protected boolean canChildScrollUp() {
        if (android.os.Build.VERSION.SDK_INT < 14) {
            ...
            if (mTargetView instanceof RecyclerView) {
                final RecyclerView recyclerView = (RecyclerView) mTargetView;
